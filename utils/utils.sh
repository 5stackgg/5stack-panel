...
source "$SCRIPT_DIR/generate_vapid_keys.sh"
source "$SCRIPT_DIR/ensure_turn_secret.sh"
source "$SCRIPT_DIR/ensure_s3_config_keys.sh"
source "$SCRIPT_DIR/resync_vault_secrets.sh"
